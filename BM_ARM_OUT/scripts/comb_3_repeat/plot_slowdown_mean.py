...
#policies = ['FCFS', 'GEDF_D', 'GEDF_N', 'LL', 'LAX', 'ELF', 'ELFD']
policies = ['FCFS', 'LAX', 'HetSched', 'ELF']
...
for app_mix in app_mixes:
    ...
    for policy in policies:
        ...
        delta[policy].append(geo_mean(per_application_delta))
...
plt.savefig('../plots/comb_3_repeat/deadline_delta_ratio_dag_mean2.pdf',
        bbox_inches='tight')
