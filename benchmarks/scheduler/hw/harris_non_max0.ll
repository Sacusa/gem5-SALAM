...
entry:
  ...
  %. = select i1 %cmp, i32* inttoptr (i64 637665312 to i32*), i32* inttoptr (i64 637599776 to i32*)
...
if.then50:                                        ; preds = %for.body40
  ...
  %26 = icmp eq i32 %25, 0
  %arrayidx60 = getelementptr inbounds i32, i32* %., i64 %24
