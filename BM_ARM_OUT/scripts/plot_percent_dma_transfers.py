...
max_transfers = {'canny': 30, 'deblur': 64, 'gru': 336, 'harris': 47,
        'lstm': 392}
...
for app_mix in app_mixes:
    ...
    norm_value = sum([4*max_transfers[app] for app in app_mix])
    for policy in policies:
        num_transfers[policy][-1] = (num_transfers[policy][-1] / norm_value) * 100
...
plt.ylabel('Percent of DMA transfers', fontsize=35)
...
plt.savefig('plots/percent_dma_transfers.pdf', bbox_inches='tight')
