        ...
        int rep_count)
{
    ...
    task->sd = (50.0 / 2691) * task->dag_deadline;
        ...
        int rep_count)
{
    ...
    task->sd = (37.0 / 2691) * task->dag_deadline;
        ...
        int rep_count)
{
    ...
    for (int i = 0; i < 2; i++) {
        ...
        task[i]->sd = (668.0 / 2691) * task[i]->dag_deadline;
        ...
        int rep_count)
{
    ...
    task[0]->sd = (40.0 / 2691) * task[0]->dag_deadline;
    ...
    task[1]->sd = (42.0 / 1715) * ((2691.0 - 937) / 2691) * \
                  task[1]->dag_deadline;
    ...
    task[2]->sd = (40.0 / 2691) * task[2]->dag_deadline;
    ...
    task[3]->sd = (1576.0 / 2691) * task[3]->dag_deadline;
    ...
    task[4]->sd = (1577.0 / 1715) * ((2691.0 - 937) / 2691) * \
                  task[4]->dag_deadline;
    ...
    task[5]->sd = (1576.0 / 2691) * task[5]->dag_deadline;
        ...
        int rep_count)
{
    ...
    *img->k = 0.05;
    ...
    task[0]->sd = (42.0 / 99) * ((2691.0 - 2553) / 2691) * \
                  task[0]->dag_deadline;
    ...
    task[1]->sd = (39.0 / 1715) * ((2691.0 - 937) / 2691) * \
                  task[1]->dag_deadline;
    ...
    task[2]->sd = (57.0 / 2691) * task[2]->dag_deadline;
    ...
    task[3]->sd = (57.0 / 99) * ((2691.0 - 2553) / 2691) * \
                  task[3]->dag_deadline;
    ...
    task[4]->sd = (39.0 / 2691) * task[4]->dag_deadline;
    ...
    task[5]->sd = (42.0 / 2691) * task[5]->dag_deadline;
    ...
    task[6]->sd = (57.0 / 2691) * task[6]->dag_deadline;
        ...
        int rep_count, bool is_last_node)
{
    ...
    task->sd = (125.0 / 2691) * task->dag_deadline;
