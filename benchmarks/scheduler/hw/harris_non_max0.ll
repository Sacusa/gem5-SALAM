...
for.cond7.preheader:                              ; preds = %for.inc17, %for.cond4.preheader
  ...
  %max_value.09 = phi float [ -1.000000e+00, %for.cond4.preheader ], [ %max_value.3.lcssa, %for.inc17 ]
  %max_i.08 = phi i32 [ -1, %for.cond4.preheader ], [ %max_i.3.lcssa, %for.inc17 ]
  %max_j.07 = phi i32 [ -1, %for.cond4.preheader ], [ %max_j.3.lcssa, %for.inc17 ]
...
for.body9:                                        ; preds = %for.inc, %for.cond7.preheader
  ...
  %max_value.15 = phi float [ %max_value.09, %for.cond7.preheader ], [ %max_value.3, %for.inc ]
  %max_i.14 = phi i32 [ %max_i.08, %for.cond7.preheader ], [ %max_i.3, %for.inc ]
  %max_j.13 = phi i32 [ %max_j.07, %for.cond7.preheader ], [ %max_j.3, %for.inc ]
...
if.then:                                          ; preds = %for.body9
  ...
  %cmp14 = fcmp ogt float %21, %max_value.15
  %22 = trunc i64 %indvars.iv to i32
  %max_j.2 = select i1 %cmp14, i32 %22, i32 %max_j.13
  %max_i.2 = select i1 %cmp14, i32 %17, i32 %max_i.14
  %max_value.2 = select i1 %cmp14, float %21, float %max_value.15
  br label %for.inc

for.inc:                                          ; preds = %for.body9, %if.then
  %max_j.3 = phi i32 [ %max_j.13, %for.body9 ], [ %max_j.2, %if.then ]
  %max_i.3 = phi i32 [ %max_i.14, %for.body9 ], [ %max_i.2, %if.then ]
  %max_value.3 = phi float [ %max_value.15, %for.body9 ], [ %max_value.2, %if.then ]
